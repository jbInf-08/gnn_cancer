...
class EnhancedDatasetBuilder:
    ...
    def build_similarity_graph(self, similarity_threshold=0.7, similarity_method='cosine'):
        ...
        if similarity_method == 'cosine':
            ...
            # Use correlation
            similarity_matrix = self.combined_features_scaled.corr().values
    ...
    def visualize_graph(self):
        ...
        plt.title("Patient Similarity Graph", fontsize=16)
        plt.axis('off')
        plt.tight_layout()
    ...
    def build_dataset(self, feature_selection='variance', n_genes=1000, n_segments=500, 
                     similarity_threshold=0.7, similarity_method='cosine'):
        ...
        graph = self.build_similarity_graph(similarity_threshold, similarity_method)
...
def main():
    ...
    logger.info("Starting enhanced dataset construction...")
    ...
    dataset = builder.build_dataset(
        ...
        similarity_threshold=0.3,  # Lower threshold for small dataset
